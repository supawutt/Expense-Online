		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Expense Online",
									"targetURL": "#ExpenseOnlineexpenseonline-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ExpenseOnlineexpenseonline-display": {
								"semanticObject": "ExpenseOnlineexpenseonline",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ExpenseOnline.expenseonline",
									"url": sap.ui.require.toUrl("ExpenseOnline/expenseonline")
								}
							}
						}
					}
